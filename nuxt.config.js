    ...
    vueI18n: {
      ...
      messages: {
        ...
        ja: {
          ...
          entryForm: 'エントリーフォーム',
          entryDescription: '内容はエントリー送信後，「自分のエントリー」ページから編集・取り下げできます。一つのアカウントで複数のエントリーは可能ですが，同じ個人，同じバンドの複数のエントリーは控えていただけると幸いです。',
          ...
          formVideoTypeNotice: '※ 動画がまだなくとも締め切りまで更新可能・取り下げ可能ですので，ぜひエントリーを✍',
          formFileURLLabel: 'エントリー動画への URL（合計時間が枠内ならば複数可）',
          formUploadLabel: '直接アップロードする(複数選択可)',
          formPublishAgreeLabel: 'エントリー動画のアーカイブ公開を許可',
          formPublishAgreeNotice: '※ アーカイブ公開を許可すると，オンラインフェス終了後のアーカイブに含まれます',
          submit: 'エントリーする',
